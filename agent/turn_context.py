...
def _memory_turn_start_and_prefetch(
    ...
    # drop injected memory. Gated on display.memory_recall_indicator (default "on"):
    # display.memory_notifications gates the background review summary, a different
    # emitter, so without this gate there was no supported way to turn the line off.
